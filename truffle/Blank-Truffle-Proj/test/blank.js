var Blank = artifacts.require("./Rps.sol"); //because truffle has no way of detecting which contracts you'll need to interact with within your
...
contract('Blank', function (accounts) { //use contract() instead of describe. enables clean room features. redeployed with a clean contract state
